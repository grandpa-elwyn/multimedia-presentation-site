...
class BandBio extends React.Component {
  ...
  _onScroll = (e) => {
    ...
    console.log(e);
    console.log(e.target.offsetParent.childNodes[1].childNodes[0].childNodes[this.state.page].offsetTop);
    console.log(this.state.pageList[this.state.page].offSetTop);
